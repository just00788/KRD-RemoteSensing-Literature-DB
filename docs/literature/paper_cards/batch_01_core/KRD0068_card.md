# Paper Card: RAP-Net: A Region Affinity Propagation-Guided Semantic Segmentation Network for Plateau Karst Landform Delineation
...
Use the full reader and Abstract/Introduction anchors to confirm exact objectives. Current grounded objective signal: RAP-Net: A Region Affinity Propagation-Guided Semantic Segmentation Network for Plateau Karst Landform Delineation

## 3. Study Area

Study area anchors: p.5, p.7. Exact place names require manual confirmation from the PDF.
...
Topic group: deep_learning_segmentation. Target evidence pages: p.1, p.1, p.1, p.1, p.2, p.3, p.3, p.3.
...
- Metrics: F1, IoU, OA, PA, Precision, Recall, UA, accuracy, bias, confusion matrix, slope
...
Located limitation/future-work evidence pages: p.2, p.4, p.12, p.14. Manual confirmation needed.
