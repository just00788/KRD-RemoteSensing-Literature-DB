# Paper Card: 基于多源数据的石漠化地区裸岩信息提取和景观格局分析
...
Use the full reader and Abstract/Introduction anchors to confirm exact objectives. Current grounded objective signal: 基于多源数据的石漠化地区裸岩信息提取和景观格局分析

## 3. Study Area

Study area anchors: p.10, p.14, p.15, p.16, p.19, p.22, p.23, p.26, p.29, p.30, p.31, p.32, .... Exact place names require manual confirmation from the PDF.
...
Topic group: bare_rock_fraction_fbr. Target evidence pages: p.4, p.4, p.4, p.4, p.4, p.4, p.4, p.4.
...
- Metrics: IoU, Kappa, OA, PA, Precision, UA, accuracy
...
Located limitation/future-work evidence pages: p.12, p.12, p.17, p.29, p.29, p.34, p.34, p.35. Manual confirmation needed.
