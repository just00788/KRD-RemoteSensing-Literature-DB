# Paper Card: Spatio-Temporal Evolution Characteristics and Driving Factors of Karst Rocky Desertification in Qujing City Based on GEE

## 1. Bibliographic Information

- Paper ID: KRD0057
- Title: Spatio-Temporal Evolution Characteristics and Driving Factors of Karst Rocky Desertification in Qujing City Based on GEE
- Chinese title if applicable: unknown
- Authors: Sustainability authors
- Year: 2024
- Journal: Sustainability
- DOI: 10.3390/su16072669
- URL: https://www.mdpi.com/2071-1050/16/7/2669
...
Use the full reader and Abstract/Introduction anchors to confirm exact objectives. Current grounded objective signal: Spatio-Temporal Evolution Characteristics and Driving Factors of Karst Rocky Desertification in Qujing City Based on GEE

## 3. Study Area

Study area anchors: p.3, p.4, p.5, p.8. Exact place names require manual confirmation from the PDF.
...
Topic group: dem_topography. Target evidence pages: p.1, p.1, p.1, p.1, p.1, p.1, p.1, p.1.

## 6. Methods

- Preprocessing: not reported
- Features: located
- Main model: GEE;time_series;DEM_ablation
...
- Metrics: IoU, OA, PA, R2, UA, accuracy, slope

## 8. Main Findings

Only include findings explicitly supported by the paper. This automated card does not record numerical findings unless manually verified in the reader/PDF. See result evidence pages: p.1, p.1, p.1, p.2, p.2, p.2, p.3, p.3.

## 9. Limitations

Located limitation/future-work evidence pages: p.11, p.11, p.11, p.13. Manual confirmation needed.
...
### Scientific rules
- Relevant target/method signals: dem_topography; GEE;time_series;DEM_ablation.
