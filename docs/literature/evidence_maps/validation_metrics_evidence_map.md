# Validation Metrics Evidence Map

Generated: 2026-07-07T16:16:01

## Supporting papers

- KRD0013: 石漠化遥感评价因子提取研究 / Remote sensing of indicators for evaluating karst rocky desertification (2011); reader: `docs/literature/readers/batch_01_core/KRD0013_reader.md`
- KRD0033: Extracting Information on Rocky Desertification from Satellite Images: A Comparative Study (2021); reader: `docs/literature/readers/batch_01_core/KRD0033_reader.md`
- KRD0035: Optimization of Rocky Desertification Classification Model Based on Vegetation Type and Seasonal Characteristic (2021); reader: `docs/literature/readers/batch_01_core/KRD0035_reader.md`
...
- KRD0054: Dynamic monitoring of rocky desertification utilizing a novel model based on Sentinel-2 images and KNDVI (2024); reader: `docs/literature/readers/batch_01_core/KRD0054_reader.md`
- KRD0057: Spatio-Temporal Evolution Characteristics and Driving Factors of Karst Rocky Desertification in Qujing City Based on GEE (2024); reader: `docs/literature/readers/batch_01_core/KRD0057_reader.md`
- KRD0058: 基于多源数据的石漠化地区裸岩信息提取和景观格局分析 (2024); reader: `docs/literature/readers/batch_01_core/KRD0058_reader.md`
...
### KRD0013
- p.1: Foundation: The Chinese Academy of Sciences Action Plan for West Development (KZCX2-XB2-08); the National Key Technology R&D Program (No.
- p.1: Karst regions in southwest China are in the central karst geomorphology of eastern Asia and are one of the largest karst areas in
- p.1: Key Laboratory of Agro-ecological Processes in Subtropical Region, Institute of Subtropical Agriculture, Chinese Academy of
- p.1: Center for Earth Observation and Digital Earth, Chinese Academy of Sciences, Beijing 100080, China;
...
### KRD0057
- p.1: Academic Editor: Antonio Miguel
- p.1: Abstract: Karst rocky desertification (KRD) has become the most serious ecological disaster in the
- p.1: Google Earth Engine (GEE) cloud platform and decision tree classification, the spatial-temporal
- p.1: driving factors of rocky desertification were explored in terms of the natural environment and socioeconomic aspects.
...
### KRD0013
- p.2: cover of vegetation are the main surface symbols and key evaluating indicators of karst rocky desertification.
- p.2: land surfaces in consideration of evaluating karst rocky desertiﬁ cation.
- p.2: fractional cover of land surfaces to acquire evaluation indicators of
- p.2: land surface in the nadir-viewing position, thus measuring an estimated circle with radius of 33 cm (Fig.
...
### KRD0057
- p.1: Google Earth Engine (GEE) cloud platform and decision tree classification, the spatial-temporal
- p.1: Keywords: upper Yangtze River; karst rocky desertification; space–time evolution; GEE; geographic
- p.2: surface features, revealing long-term dynamic trends.
- p.2: monitoring combines spatial and temporal information, recording surface changes in a
...
### KRD0013
- p.1: Candidate, came from Yanling Henan Province, graduated from Nanjing Agricultural
- p.1: University in 2005, Research ﬁ elds: ecological remote sensing, remotely sensed monitoring karst rocky desertiﬁ cation, had published more than 10 papers.
- p.1: are sensitive to global changes (Yuan, 1999; Liu, et al., 2009).
- p.1: soil is not continuous, resulting in high spatial and temporal heterogeneity.
...
### KRD0057
- p.1: Spatio-Temporal Evolution
- p.1: Received: 29 January 2024
- p.1: Spatio-Temporal Evolution Characteristics and Driving Factors
- p.1: Abstract: Karst rocky desertification (KRD) has become the most serious ecological disaster in the
...
### KRD0013
- p.1: soil is not continuous, resulting in high spatial and temporal heterogeneity.
- p.1: subjective and low efﬁ cient, and might result in signiﬁ cant errors.
- p.1: consistent results with the ﬁ eld measurement of non-vegetation land cover fractions.
- p.2: However, the increase of bands would result in redundant information and thus augment the complexity of data processing.
...
### KRD0057
- p.1: will not occur, thus reducing the accuracy of KRD interpretations [12–14].
- p.1: over an extended timeframe, this study utilized a time series analysis approach.
- p.1: The achieved research results will provide decision support for
- p.2: soil, purple soil, coarse bone soil, mountain meadow soil, paddy soil, red
...
### KRD0057
- p.11: types (including marshland and bare land) significantly increased the uncertainty of the
- p.11: future work on rocky desertification prevention and control, and no generalizations should
- p.11: the uncertainty of rocky desertification increases considerably when the area of cultivated
...
- KRD0013: KRD classification/information extraction; Remote Sensing/KRD relevance
- KRD0033: KRD classification/information extraction
- KRD0035: KRD classification/information extraction; machine-learning classification
- KRD0051: KRD classification/information extraction; semantic segmentation baseline/model; DEM/topographic factors
- KRD0054: KRD classification/information extraction
- KRD0057: KRD classification/information extraction; DEM/topographic factors
- KRD0058: FBR/bare-rock fraction
